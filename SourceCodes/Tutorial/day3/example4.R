if(!require(spatstat)) install.packages("spatstat",repos = "http://cran.us.r-project.org"); library("spatstat")
...
if(!require(gridGraphics)) install.packages("gridGraphics",repos = "http://cran.us.r-project.org"); library("gridGraphics")
